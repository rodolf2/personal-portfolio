function App() {
  return (
    ...
    {/* k */}
      ...
      <div class="vg-page page-home" id="home" style={{backgroundImage: "url(../assets/img/bg_image_1.jpg)"}}>
        {/* Navbar */}
      ...
      <div class="vg-page page-funfact" style={{backgroundImage: "url(../assets/img/bg_banner.jpg)"}}>
        <div class="container">
